...
from SpeakerEmbeddings.TTS.config import load_config
from SpeakerEmbeddings.TTS.encoder.utils.generic_utils import setup_encoder_model
from SpeakerEmbeddings.TTS.utils.audio import AudioProcessor
        ...
        if isinstance(wav_file, list):
            ...
            for wf in wav_file:
                ...
                if embeddings is None:
                    ...
                    embeddings += embedding
            return (embeddings / len(wav_file))
